...
export default function SignupPage() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 font-sans selection:bg-primary/20">
			...
			<div className="w-full max-w-[400px] relative z-10">
				...
				<div className="text-center mb-6">
					<LogoIcons.scenify className="w-16 h-16 text-primary mb-4 mx-auto" />
